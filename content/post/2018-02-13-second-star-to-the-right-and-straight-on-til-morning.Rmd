...
I wanted to draw a little more attention to starbrgazing and just how much you can discover by using the more social aspect of github, following people, a pile of IFTTT alerts and reviewing and testing out what they star. 
...
Yeah, that's a pretty heavy amount of R, with an increasing trend in recent years. Lets just look at the R projects for now.  What sort of R projects has he starred over time, and how popular are those projects?
...
x <- waffle(set_names(cat_data$n, cat_data$category), colors = nord(palette = "lumina", 5), size = 0.4, rows = 10, legend_pos = "right", equal = TRUE, title = "Delicious Category Waffle of Hrbrstarred R Projects", pad = 2) 
...
No surprise that the bulk of R projects are packages, with a smattering of educational stuff, shiny applications and analysis driven projects.  
