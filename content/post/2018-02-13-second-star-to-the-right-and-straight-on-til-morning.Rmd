...
```{r waffle, fig.width = 10, fig.height = 10, fig.showtext = TRUE}
...
x <- waffle(set_names(cat_data$n, cat_data$category), colors = nord(palette = "lumina", 5), size = 0.4, rows = 10, legend_pos = "right", equal = TRUE, title = "Delicious Category Waffle of Hrbrstarred R Projects") 
